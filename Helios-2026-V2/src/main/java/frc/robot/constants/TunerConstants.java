...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                // Stator stays at 60 (the low-speed torque that cured the lockup is stator-driven,
                // and matches the Tuner X project's 60 A value). Supply backed off 40 -> 30 A
    ...
    // Nominal, not measured. This scales EVERY odometry translation linearly: a wheel worn or
    // compressed 2% under load makes the robot think it has travelled 2% further than it has, and
    // that error accumulates between AprilTag corrections. TODO measure on the robot -- push it a
    // tape-measured distance in a straight line and compare against the reported pose delta, then
    // scale this radius by (actual / reported). Do this together with the kSpeedAt12Volts check.
